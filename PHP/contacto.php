            ...
            <div class="abs-center">
                <form method="POST" class="formulario-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="fname" name="name" placeholder="Nombre" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea class="form-control" id="message" name="message"
                                placeholder="Introduce tu mensaje y te contestaremos lo antes posible"
                                rows="5"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-12 text-center">
                            <button type="submit" class="btn btn-primary btn-lg" id="botonEnviar">Enviar</button>
                        </div>
                    </div>
                    </fieldset>
                </form>
